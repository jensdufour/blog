...
title: About Me
status: publish
seo_title: "About Me - Jens Du Four"
meta_description: "Cloud Endpoint Solution Engineer at Microsoft, helping organizations manage and secure their devices with Intune, Entra ID, and Windows 365."
focus_keyphrase: "Jens Du Four"
---

## Hey, I'm Jens

I'm a Cloud Endpoint Solution Engineer at **Microsoft**, based in Belgium. For over four years I've been helping large organizations manage and secure their laptops, desktops, and mobile devices using cloud-based tools like **Microsoft Intune**, **Entra ID**, **Defender for Endpoint**, and **Windows 365**.

My role sits between customers and the product teams at Microsoft. I help customers design and roll out solutions, test new features before they ship, find workarounds when things don't work as expected, and feed what I learn back into the product so it gets better for everyone.
...
- Cybersecurity Architect Expert, Microsoft (2024)
...
B.Sc. Applied Computer Sciences, Hogeschool Gent (2016 to 2019)

## Languages

Dutch (native), English (C2), French (B1)
